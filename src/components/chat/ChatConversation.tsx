...
export const ChatConversation = ({
 ...
 {searchOpen ? (
 <div className="flex items-center gap-2 border-b border-border bg-card px-4 py-2 sm:px-6">
 <SearchIcon
 ...
 isDeclined && "pointer-events-none select-none ",
 )}
 >
 {loading ? (
...
const DeclinedFooter = ({
 ...
 <footer className="flex flex-col gap-3 border-t border-border bg-card px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
 <div>
 <p className="text-sm font-medium text-foreground">
