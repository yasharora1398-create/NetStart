...
export const AppShell = () => {
 ...
 {/* App header */}
 <header className="flex items-center justify-between px-5 py-3 border-b border-border z-20 bg-background">
 ...
 className="relative h-8 w-8 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-gold transition-colors"
 ...
 {/* Bell dropdown */}
 {bellOpen && (
 <div className="absolute top-14 right-3 z-30 w-60 rounded-sm border border-gold bg-card shadow-xl overflow-hidden">
 ...
 {/* Match top tabs */}
 {tab === "match" && (
 <div className="flex items-center gap-5 px-5 pt-3 text-xs font-mono uppercase tracking-widest border-b border-border">
 <TopTab
 label="For you"
 ...
 {/* Bottom tab bar */}
 <nav className="absolute bottom-0 inset-x-0 bg-obsidian border-t border-border px-6 py-2.5 pb-5 flex items-center justify-between z-20">
 <TabIcon
...
const NotifItem = ({ title, body }: { title: string; body: string }) => (
 <li className="px-3 py-2.5 hover:bg-background transition-colors">
...
const SavedScreen = () => (
 ...
 <p className="text-center text-[10px] font-mono uppercase tracking-widest text-muted-foreground pt-2">
...
const BrowseScreen = () => (
 ...
 className="w-full h-9 pl-8 pr-2.5 rounded-sm border border-border bg-card text-xs focus:outline-none focus:border-gold"
 readOnly
 />
 </div>
...
const ThreadsScreen = () => (
 ...
 <span className="text-[9px] font-mono uppercase tracking-widest text-muted-foreground flex-shrink-0">
 {t.time}
 </span>
 </div>
 <p
 ...
 <div className="px-4 pt-4">
 <div className="rounded-sm border border-dashed border-border bg-card p-4 text-center">
...
const YouScreen = () => {
 ...
 src={me.image}
 alt={me.name}
 className="h-16 w-16 rounded-sm object-cover border border-gold flex-shrink-0"
 loading="lazy"
 />
