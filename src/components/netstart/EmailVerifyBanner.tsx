...
export const EmailVerifyBanner = () => {
 ...
 return (
 <div className="relative z-50 px-3 sm:px-6 pt-2 pb-1">
 <div className="container max-w-3xl">
 <div className="rounded-sm border border-gold bg-card shadow-lg p-3 sm:p-4 flex items-center gap-3 flex-wrap">
