...
export const MobileBottomNav = () => {
 ...
 className="fixed right-3 z-40 flex h-10 w-10 items-center justify-center rounded-full border border-border bg-card text-gold shadow-lg transition-colors hover:bg-card md:hidden"
 style={{
