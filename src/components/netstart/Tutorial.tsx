...
export const Tutorial = () => {
 ...
 const cardClass =
 "relative bg-obsidian border border-gold rounded-sm p-5 shadow-elite w-[90vw] max-w-sm";
 ...
 return (
 <div className="fixed bottom-5 right-5 md:bottom-8 md:right-8 z-50 animate-fade-up">
 <div className={cardClass.replace("border-gold", "border-primary")}>
 <button
 onClick={dismiss}
 className="absolute top-2 right-2 text-muted-foreground hover:text-foreground transition-colors"
 ...
 <button
 onClick={dismiss}
 className="text-xs font-mono uppercase tracking-widest bg-neutral-800 text-muted-foreground hover:bg-neutral-700 hover:text-foreground py-2.5 px-4 rounded-sm transition-colors"
 >
 Skip
 </button>
 <button
