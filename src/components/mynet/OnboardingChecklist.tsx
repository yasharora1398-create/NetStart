...
export const OnboardingChecklist = ({
 ...
 <div className="h-5 w-5 rounded-full bg-destructive border border-destructive flex items-center justify-center">
 ...
 <div className="w-3/4 max-w-md rounded-sm border border-gold bg-card shadow-2xl p-5 sm:p-6 text-center">
