...
const PublicProfileBody = ({
 ...
 <section className="rounded-sm border border-dashed border-border bg-background p-4">
 ...
 <div className="border-t border-border bg-background px-8 py-4 flex items-center gap-2 flex-wrap">
 <Button
 variant="outlineGold"
 size="lg"
