...
export const MyNetDashboard = ({
  ...
  return (
    <>
      ...
      {/* LOOKING — only visible if they filled it in or are editing */}
      {(editing || hasCandidate) && (
        <Section
      ...
      {/* BUILDING — only visible if they have projects or are editing */}
      {(editing || hasProjects) && (
        <Section
          ...
          {projects.length === 0 ? (
            <div className="rounded-sm border border-dashed border-border bg-card/40 p-10 text-center">
              ...
              <p className="text-sm text-muted-foreground max-w-md mx-auto mb-5">
                Spin up your first project to start finding the right people.
              </p>
              <Button variant="gold" size="lg" onClick={onNewProject}>
                <Plus className="h-4 w-4" />
