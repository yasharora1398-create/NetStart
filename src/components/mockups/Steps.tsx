...
const INK_DIM = "hsl(var(--muted-foreground))"; // solid muted, no alpha
const INK_MUTED = "hsl(var(--muted-foreground))";
const LINE = "hsl(var(--border))"; // solid border, no alpha
const LINE_STRONG = "hsl(var(--border))"; // border default
const CARD_BG = "hsl(var(--card))"; // solid card, no alpha
...
const RUST_GLOW = "hsl(var(--primary))"; // glow tone collapsed to solid primary
...
const GREEN_GLOW = "hsl(var(--primary))"; // glow tone collapsed to solid primary
...
// Solid card base - no backdrop blur, no rgba shadow halos. Just a
// flat card surface that reads the same in light + dark mode.
const baseCard = {
 fontFamily: FONT,
 color: INK,
...
export const StepAccepted = () => (
 ...
 >
 {/* badge - solid primary fill, no glow halo */}
 <div
 style={{
 position: "relative",
 width: 76,
