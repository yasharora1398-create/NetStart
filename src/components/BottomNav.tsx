...
export const BottomNav = () => {
 ...
 <nav
 aria-label="Primary"
 className="fixed bottom-3 left-1/2 z-40 w-[min(420px,calc(100%-1.5rem))] -translate-x-1/2 rounded-full border-2 border-foreground bg-background shadow-pop-white pb-[env(safe-area-inset-bottom)]"
 >
