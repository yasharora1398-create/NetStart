...
const WhyCard = ({ item, index, scrollRoot }: CardProps) => {
 ...
 <div
 ref={ref}
 className={`relative overflow-hidden rounded-3xl border-2 border-foreground bg-card p-6 transition-all duration-700 ease-out ${
 inView
 ...
 <span
 aria-hidden
 className="pointer-events-none absolute -right-8 -top-8 h-24 w-24 rounded-full bg-primary "
 />
 </div>
 );
};
