...
const ExploreGrid = () => {
 ...
 <Link
 to={t.to}
 className="relative block h-full rounded-sm border border-border bg-card p-5 transition-colors hover:border-gold hover:bg-card"
 >
...
const FinalCTA = () => {
 ...
 const isAuthed = !!user;
 return (
 <section className="relative border-t border-border bg-card px-4 sm:px-8 py-32 md:py-40">
